...
const Index = () => {
  return (
    <Layout>
      ...
      <section aria-label="Hero banner" className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <div className="bg-white/10 backdrop-blur-2xl rounded-2xl p-10 md:p-14 border border-white/20 shadow-2xl">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm px-6 py-3 rounded-full border border-white/30 mb-8">
                <Zap className="w-5 h-5 text-blue-300" />
                <span className="text-white/90 font-medium text-lg">Next-Generation Digital Solutions</span>
              </div>
              
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 text-white leading-[0.9] tracking-tight">
                Transform Your
                <span className="block bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 bg-clip-text text-transparent mt-3">
                  Digital Future
                </span>
              </h1>
              
              <p className="text-lg md:text-2xl text-white/85 mb-10 leading-relaxed max-w-4xl mx-auto font-light">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link
                  to="/contact"
                  className="group bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-10 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-blue-500/25 flex items-center justify-center gap-3 min-w-[220px]"
                >
                  Start Your Journey
                ...
                <Link
                  to="/solutions"
                  className="bg-white/20 backdrop-blur-sm border-2 border-white/30 text-white hover:bg-white/30 px-10 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 min-w-[220px]"
                >
                  Explore Solutions
                </Link>
              </div>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">Launch Fast</h3>
      ...
      <section className="py-20 px-6 bg-white" aria-label="Our digital marketing services">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 text-gray-900 leading-[0.9] tracking-tight">
              Next-Generation
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" role="list">
            ...
            <div className="group bg-gradient-to-br from-white to-blue-50/50 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-blue-200 transform hover:-translate-y-3">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 leading-tight">Social Media Mastery</h3>
              ...
              <Link to="/services/social-media" className="inline-flex items-center text-blue-600 hover:text-blue-700 font-semibold group-hover:gap-3 gap-2 transition-all text-base">
                Learn More <ArrowRight className="w-5 h-5" />
              </Link>
            </div>

            <div className="group bg-gradient-to-br from-white to-purple-50/50 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-purple-200 transform hover:-translate-y-3">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 leading-tight">Content Excellence</h3>
              <p className="text-gray-600 mb-6 leading-relaxed text-base">
                Compelling, data-driven content that resonates with Australian audiences and converts visitors into loyal customers.
              </p>
              <Link to="/services/content-creation" className="inline-flex items-center text-purple-600 hover:text-purple-700 font-semibold group-hover:gap-3 gap-2 transition-all text-base">
                Learn More <ArrowRight className="w-5 h-5" />
              </Link>
            </div>

            <div className="group bg-gradient-to-br from-white to-green-50/50 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-green-200 transform hover:-translate-y-3">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 leading-tight">SEO Domination</h3>
              <p className="text-gray-600 mb-6 leading-relaxed text-base">
                Advanced SEO strategies that put your business at the top of Australian search results and drive organic growth.
              </p>
              <Link to="/services/seo" className="inline-flex items-center text-green-600 hover:text-green-700 font-semibold group-hover:gap-3 gap-2 transition-all text-base">
                Learn More <ArrowRight className="w-5 h-5" />
              </Link>
            </div>

            <div className="group bg-gradient-to-br from-white to-pink-50/50 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-pink-200 transform hover:-translate-y-3">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 leading-tight">Brand Evolution</h3>
              <p className="text-gray-600 mb-6 leading-relaxed text-base">
                Strategic brand development that positions your business as a leader in the Australian market.
              </p>
              <Link to="/services/branding" className="inline-flex items-center text-pink-600 hover:text-pink-700 font-semibold group-hover:gap-3 gap-2 transition-all text-base">
                Learn More <ArrowRight className="w-5 h-5" />
              </Link>
            </div>

            <div className="group bg-gradient-to-br from-white to-cyan-50/50 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-cyan-200 transform hover:-translate-y-3">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 leading-tight">Precision Advertising</h3>
              <p className="text-gray-600 mb-6 leading-relaxed text-base">
                Data-driven advertising campaigns that maximize ROI and reach your ideal Australian customers.
              </p>
              <Link to="/services/digital-ads" className="inline-flex items-center text-cyan-600 hover:text-cyan-700 font-semibold group-hover:gap-3 gap-2 transition-all text-base">
                Learn More <ArrowRight className="w-5 h-5" />
              </Link>
            </div>

            <div className="group bg-gradient-to-br from-white to-orange-50/50 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-orange-200 transform hover:-translate-y-3">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-6 text-gray-900 leading-tight">AI Innovation</h3>
              <p className="text-gray-600 mb-6 leading-relaxed text-base">
                Cutting-edge AI solutions that automate, optimize, and revolutionize your marketing approach.
              </p>
              <Link to="/services/ai-marketing" className="inline-flex items-center text-orange-600 hover:text-orange-700 font-semibold group-hover:gap-3 gap-2 transition-all text-base">
                Learn More <ArrowRight className="w-5 h-5" />
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-gray-50 to-blue-50/30" aria-label="About Heidigital Australia">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="absolute -inset-6 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl blur-2xl"></div>
              <img
            ...
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 bg-gray-100 text-gray-700 px-6 py-3 rounded-full font-medium mb-6 text-lg">
                <Award className="w-5 h-5" />
                Innovation Leaders
              </div>
              
              <h2 className="text-4xl md:text-5xl font-bold leading-[0.9] tracking-tight">
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white" aria-label="Technology-powered marketing solutions">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white/90 px-6 py-3 rounded-full font-medium mb-6 border border-white/20 text-lg">
              <Brain className="w-5 h-5" />
              Technology-Powered Solutions
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-8 leading-[0.9] tracking-tight">
              Advanced Technology
              <span className="block bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mt-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8" role="list">
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 group">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-6 leading-tight">Intelligent Content Systems</h3>
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 group">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-6 leading-tight">Predictive Market Analytics</h3>
              <p className="text-white/70 leading-relaxed text-base">
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 group">
              <div className="w-20 h-20 bg-gradient-to-br from-green-500 to-teal-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                <Settings className="h-10 w-10 text-white" />
              </div>
              <h3 className="text-xl md:text-2xl font-bold mb-6 leading-tight">Automated Optimization</h3>
              <p className="text-white/70 leading-relaxed text-base">
          ...
          <div className="text-center mt-16">
            <Link
              ...
              className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-10 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl"
            >
      ...
      <section className="py-20 px-6 bg-gray-50" aria-label="Our portfolio showcase">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-6 py-3 rounded-full font-medium mb-6 text-lg">
              <Globe className="w-5 h-5" />
              Success Stories
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900 leading-[0.9] tracking-tight">
              Proven Results for
              <span className="block bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mt-3">
          ...
          <div className="text-center mt-16">
            <Link
              to="/portfolio"
              className="inline-flex items-center gap-3 text-blue-600 hover:text-blue-700 font-semibold text-lg group"
            >
      ...
      <section className="py-20 px-6 bg-white" aria-label="Contact form and information">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-6 p-6 bg-gray-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@heidigital.com.au" className="text-blue-600 hover:text-blue-700 text-base">
                ...
                <div className="flex items-center gap-6 p-6 bg-gray-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <a href="tel:+61390000000" className="text-purple-600 hover:text-purple-700 text-base">
                      +61 3 9000 0000
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-blue-50/50 p-8 rounded-2xl shadow-lg border border-gray-100">
              <ContactForm />
            </div>
          </div>
        </div>
