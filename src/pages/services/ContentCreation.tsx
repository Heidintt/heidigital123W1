          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gray-600 mb-6">
                In today's digital landscape, content is the cornerstone of effective marketing. At Heidigital, we create content that not only captures attention but also drives meaningful engagement and conversions.
              </p>
              <p className="text-gray-600 mb-6">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <PenSquare className="h-12 w-12 text-blue-600 mb-4" />
