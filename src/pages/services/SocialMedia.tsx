          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gray-600 mb-6">
                At Heisocial, we believe that effective social media marketing is both an art and a science. Our approach combines creative content creation with data analytics to develop strategies that resonate with your audience and achieve your business goals.
              </p>
              <p className="text-gray-600 mb-6">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md card-hover">
              <Calendar className="h-12 w-12 text-heisocial-blue mb-4" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md card-hover">
              <CheckCircle2 className="h-12 w-12 text-heisocial-blue mb-4" />
