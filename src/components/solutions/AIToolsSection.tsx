...
const AIToolsSection = () => {
  ...
  return <section className="py-16 px-4">
      <div className="container mx-auto">
        <SectionHeading title="Marketing Tools" subtitle="Powerful tools to optimize your marketing efforts and campaigns" centered />

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {tools.map((tool, index) => <Card key={index} className="card-hover">
              <CardHeader>
