          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div className="h-48 overflow-hidden">
              <img
                ...
                alt="Sun Life Vietnam I Choose The Sun Campaign"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
              />
            </div>
            <div className="p-6">
              <div className="flex flex-wrap gap-2 mb-3">
                <span className="bg-pink-100 text-pink-700 px-2 py-1 rounded-full text-xs font-medium">Social Media</span>
                <span className="bg-yellow-100 text-yellow-700 px-2 py-1 rounded-full text-xs font-medium">Viral Campaign</span>
              </div>
              <h3 className="text-xl font-bold mb-3">Sun Life "I Choose The Sun"</h3>
              <p className="text-gray-600 mb-4">Viral influencer campaign generating 75.6M views and 8,000+ user videos during COVID-19 pandemic.</p>
              <Button asChild variant="outline" size="sm">
